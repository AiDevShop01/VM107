"""Phase 169 Plan 06 — ConsumerDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.consumer_domain_analyst.yaml``, Plan 169-05).
...
class ConsumerDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Consumer domain."""
