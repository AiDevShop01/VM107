"""Phase 95-12 — ExternalSectorDomainAnalyst specialist (narrative-only).

EXPLAINS the External Sector Domain (one of the 12 canonical macro domains —
...
class ExternalSectorDomainAnalyst:
    """Specialist analyst for the External Sector Domain."""
    ...
    def invoke(
        ...
        assert domain.slug == self.DOMAIN_SLUG, (
            f"ExternalSectorDomainAnalyst received domain.slug={domain.slug!r} — "
