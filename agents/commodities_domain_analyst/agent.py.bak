"""Phase 95-12 — CommoditiesDomainAnalyst specialist (narrative-only).

EXPLAINS the Commodities Domain (one of the 12 canonical macro domains —
...
class CommoditiesDomainAnalyst:
    """Specialist analyst for the Commodities Domain."""
    ...
    def invoke(
        ...
        assert domain.slug == self.DOMAIN_SLUG, (
            f"CommoditiesDomainAnalyst received domain.slug={domain.slug!r} — "
