"""Phase 95-12 — InflationDomainAnalyst specialist (narrative-only).

EXPLAINS the Inflation Domain (one of the 12 canonical macro domains —
...
class InflationDomainAnalyst:
    """Specialist analyst for the Inflation Domain."""
    ...
    def invoke(
        ...
        assert domain.slug == self.DOMAIN_SLUG, (
            f"InflationDomainAnalyst received domain.slug={domain.slug!r} — "
