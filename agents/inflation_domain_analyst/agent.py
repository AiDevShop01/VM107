"""Phase 169 Plan 06 — InflationDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.inflation_domain_analyst.yaml``, Plan 169-05).
...
class InflationDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Inflation domain."""
