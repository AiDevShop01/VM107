"""Phase 169 Plan 06 — HousingDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.housing_domain_analyst.yaml``, Plan 169-05).
...
class HousingDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Housing domain."""
