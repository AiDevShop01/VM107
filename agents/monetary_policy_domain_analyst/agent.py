"""Phase 169 Plan 06 — MonetaryPolicyDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.monetary_policy_domain_analyst.yaml``, Plan 169-05).
...
class MonetaryPolicyDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Monetary Policy domain."""
