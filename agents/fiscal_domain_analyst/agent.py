"""Phase 169 Plan 06 — FiscalDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.fiscal_domain_analyst.yaml``, Plan 169-05).
...
class FiscalDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Fiscal domain."""
