"""Phase 169 Plan 06 — LabourDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.labour_domain_analyst.yaml``, Plan 169-05).
...
class LabourDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Labour domain."""
