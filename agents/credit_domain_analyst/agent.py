"""Phase 169 Plan 06 — CreditDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.credit_domain_analyst.yaml``, Plan 169-05).
...
class CreditDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Credit domain."""
