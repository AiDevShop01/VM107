"""Phase 169 Plan 06 — ManufacturingDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.manufacturing_domain_analyst.yaml``, Plan 169-05).
...
class ManufacturingDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Manufacturing domain."""
