"""Phase 169 Plan 06 — GrowthDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.growth_domain_analyst.yaml``, Plan 169-05).
...
class GrowthDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Growth domain."""
