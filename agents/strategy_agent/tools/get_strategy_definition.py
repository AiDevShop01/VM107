...
Per-profile denial stub overrides the global tools/get_strategy_definition.py
...
class GetStrategyDefinition(Tool):
    async def execute(self, **kwargs) -> Response:
        msg = (
            "Tool 'get_strategy_definition' is NOT AVAILABLE to strategy_agent (hard-scoped "
