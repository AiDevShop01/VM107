"""Phase 169 Plan 06 — FinancialConditionsDomainAnalyst (config-only subclass of DomainAgent).
...
(``registry/agent_profile/vm107.financial_conditions_domain_analyst.yaml``, Plan 169-05).
...
class FinancialConditionsDomainAnalyst(DomainAgent):
    """Config-only specialist analyst for the Financial Conditions domain."""
